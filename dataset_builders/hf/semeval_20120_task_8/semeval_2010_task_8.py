"""The SemEval-2010 Task 8 on Multi-way classification of semantic relations between pairs of
nominals."""
...
class SemEval2010Task8(datasets.GeneratorBasedBuilder):
    """The SemEval-2010 Task 8 focuses on Multi-way classification of semantic relations between
    pairs of nominals.

    The task was designed to compare different approaches to semantic relation classification and
    to provide a standard testbed for future research.
    """
